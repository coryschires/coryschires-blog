...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
    ...
    <link rel="icon" type="image/png" href="<?php bloginfo('stylesheet_directory'); ?>/images/favicon_white.png" />
		...
		<!-- scripts for blog post examples -->
            <script src="<?php bloginfo('stylesheet_directory'); ?>/js/jquery.quote_rotator.js" type="text/javascript" charset="utf-8"></script>
		<!-- scripts for blog post examples -->
			...
			<div class="hidden" id="resume_wrap">
			    <div id="resume_page">
					...
					<div class="resume_item">
						<a href="<?php bloginfo('stylesheet_directory'); ?>/resume/cory_schires_resume.pdf">
				    		<img src="<?php bloginfo('stylesheet_directory'); ?>/images/resume_icon.jpg" alt="Resume Icon" />							
						</a>
						<p>
					...
					<div class="resume_item">
						<a href="<?php bloginfo('stylesheet_directory'); ?>/resume/cory_schires_code_samples.pdf">
							<img src="<?php bloginfo('stylesheet_directory'); ?>/images/code_icon.jpg" alt="Code Icon" />						
						</a>
						<p>
					...
					<div class="resume_item last">
						<a href="<?php bloginfo('stylesheet_directory'); ?>/resume/cory_schires_portfolio.pdf">
							<img src="<?php bloginfo('stylesheet_directory'); ?>/images/portfolio_icon.jpg" alt="Portfolio Icon" />
						</a>
						<p>
